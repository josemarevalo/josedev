<template>
  <div class="testimonial-card md:flex md:flex-row lg:flex-col">
    ...
    <div class="testimonial-card__content mt-[24px] md:ml-[24px] lg:ml-0">
      <p class="">"{{ text }}"</p>
      <div class="mt-[30px] lg:mt-[40px] font-bold">
        <p>{{ authorName }}</p>
        <p>{{ authorRole }}</p>
      </div>
    </div>
...
<style lang="postcss">
.testimonial-card {
  @apply bg-white pb-[24px] px-[24px] md:pl-[16px] lg:pl-[24px] rounded-xl shadow text-xl text-[#1d1d1d] mt-20;
}
